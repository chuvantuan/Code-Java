...
delete from staff where idnv = '123admin';
INSERT INTO `staff` (`idnv`, `name`, `sdt`, `email`, `sex`, `rank`, `blockAt`, `password`)
VALUES ('123admin', 'admin1', '0123456789', 'tuan123@gmail.com', 1, 'admin', NULL, 'xAqQiyJAjBg6vDs4EZ3Nb8QxcpJC/Sg1PLuFmoCIPkTehXlydt+haJgdkrZ2hxgM');
-- --------------------------------------------------------
